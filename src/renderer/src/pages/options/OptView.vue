                ...
                <div class="opt-item">
                    ...
                    <div class="ss-range">
                        <input v-model="runtimeData.sysConfig.custom_scale"
                            ...
                            type="range" min="0.5" max="1.5" step="0.05" name="custom_scale" @input="save">
                        <span>{{ Math.round(runtimeData.sysConfig.custom_scale * 100) }}%</span>
                        <button class="ss-button" style="width: 60px; font-size: 0.8rem; margin-left: 10px;" @click="runtimeData.sysConfig.custom_scale = 1.0;runAS('custom_scale', 1.0)">{{ $t('重置') }}</button>
                    </div>
                </div>
                <div class="opt-item">
                    ...
                    <div class="ss-range">
                        ...
                        <button class="ss-button" style="width: 60px; font-size: 0.8rem; margin-left: 10px;" @click="runtimeData.sysConfig.font_scale = 1.0;runAS('font_scale', 1.0)">{{ $t('重置') }}</button>
                    </div>
                </div>
            </template>
        </div>
