    ...
    <div class="opt-page">
        ...
        <div v-if=" !napcat" class="ss-card">
            ...
            <template v-if="runtimeData.sysConfig.opt_auto_gtk != true">
                ...
                <div v-if="runtimeData.sysConfig.opt_dark || runtimeData.sysConfig.opt_auto_dark" class="opt-item">
                    <div :class="checkDefault('opt_deeper_dark')" />
            ...
            <template v-if="!runtimeData.sysConfig.chat_more_blur">
                ...
                <div class="opt-item">
                    ...
                    <div>
                        <span>{{ $t('界面缩放') }}</span>
                        <span>{{ $t('不建议缩放到 70% 以下或 130% 以上') }}</span>
                    </div>
                    <div class="ss-range">
