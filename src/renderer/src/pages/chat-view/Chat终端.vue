...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            sanitizeCommandHtml(value: unknown) {
            ...
            getRecallName(id: number) {
                ...
                if (runtimeData.chatInfo.show.type === 'group') {
                    // 寻找群成员信息
                    if (Array.isArray(runtimeData.chatInfo.info.group_members)) {
                        const back =
